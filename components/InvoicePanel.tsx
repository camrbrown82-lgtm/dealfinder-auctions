...
import { INTERAC_EMAIL, PICKUP_INSTRUCTIONS, fulfillmentInstructions, fulfillmentLabel } from "@/lib/payments";
...
export function InvoicePanel({
  ...
  return (
    <article className="comic-panel p-4">
      ...
      {win.fulfillment === "pickup" || win.paymentMethodKey === "pay_on_arrival" ? (
        <p className="mt-3 border-4 border-black bg-white px-3 py-2 font-comic text-sm">
          {PICKUP_INSTRUCTIONS}
        </p>
      ) : null}

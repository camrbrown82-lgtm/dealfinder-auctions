-- Buy-Now credit tiers, pending invoice queue, Sunday batch invoice stamp
...
create index if not exists pending_invoice_items_event_idx
  on public.pending_invoice_items (event_id);

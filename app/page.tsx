...
import { SiteFooter } from "@/components/app-shell";
    ...
    <div className="flex min-h-screen flex-col bg-brand-ink">
      <section className="relative flex min-h-[calc(100vh-12rem)] flex-1 flex-col items-center justify-center overflow-hidden px-4 py-12 text-center">
        ...
        <div
          ...
          style={{ backgroundImage: "radial-gradient(circle, #fff7d1 1.5px, transparent 1.5px)", backgroundSize: "22px 22px" }}
        />
        <p className="relative font-display text-2xl uppercase tracking-widest text-brand-red pop-shadow-red sm:text-3xl">POW · BAM · LIVE</p>
        <h1 className="relative mx-auto mt-4 w-full max-w-6xl">
          <span className="sr-only">DealFinder Auctions</span>
          <span className="relative mx-auto block h-[min(42vh,22rem)] w-full max-w-5xl">
            <Image src="/logo.webp" alt="" fill className="object-contain" sizes="100vw" priority />
          </span>
        </h1>
